...
NUMERIC_COLUMNS = [
    ...
    "market_index", "quote_signal", "day_of_week", "month", "day_of_month", "day_of_year", "week_of_year",
    "quarter", "is_weekend", "is_q4", "days_to_christmas", "days_to_thanksgiving", "is_holiday_week",
    "distance_per_weight", "weight_x_distance",
